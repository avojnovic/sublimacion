...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td colspan="2">
            <asp:GridView ID="GridViewProductos" runat="server" GridLines="None" AllowPaging="true" Width="400px"
                HorizontalAlign="Center" PageSize="20" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false" AutoGenerateEditButton="true"
                OnRowEditing="GridViewProductos_RowEditing" OnPageIndexChanging="GridViewProductos_PageIndexChanging"
                OnRowUpdating="GridViewProductos_OnRowUpdating" OnRowCancelingEdit="GridViewProductos_OnRowCancelingEdit">
